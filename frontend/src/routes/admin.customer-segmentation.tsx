...
export const Route = createFileRoute("/admin/customer-segmentation")({
  ...
  component: AdminCustomerSegmentation,
});

function AdminCustomerSegmentation() {
  ...
  const handleExportCSV = () => {
    try {
      const headers = ["Customer", "Tier Segment", "Total Spending", "Orders Count", "Average Spending", "Percentage Contribution", "City"];
      ...
      link.setAttribute("download", `ShopSense_CustomerSegmentation_${new Date().toISOString().split("T")[0]}.csv`);
  ...
  return (
    <div className="space-y-6 pb-12">
      <PageHeader
        ...
        description="Classify your buyers, analyze revenue contribution limits, and target specific groups dynamically."
        actions={
          <>
            ...
            <Button variant="ghost" size="icon" onClick={async () => {
              ...
              toast.success("Segmentation statistics updated");
            }}>
      ...
      <Card className="p-4 bg-muted/20 border-dashed space-y-4">
        <div className="grid gap-3 grid-cols-1 sm:grid-cols-2 md:grid-cols-5 items-end">
          ...
          <div className="space-y-1.5">
            <label className="text-xs font-semibold text-muted-foreground">Category Segment</label>
            <Select
          ...
          <div className="space-y-1.5">
            <label className="text-xs font-semibold text-muted-foreground">Customer City</label>
            <Select
