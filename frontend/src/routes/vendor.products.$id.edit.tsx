...
function EditProduct() {
  ...
  return (
    <div>
      <BackLink to="/vendor/products/$id" label="Back to product" />
      ...
      <Card className="p-6">
        <form onSubmit={form.handleSubmit(async (data) => {
          try {
            ...
            nav({ to: "/vendor/products/$id", params: { id: p.id } });
          } catch (err: any) {
          ...
          <div className="flex items-center justify-end gap-2 md:col-span-2">
            <Button type="button" variant="outline" onClick={() => nav({ to: "/vendor/products/$id", params: { id: p.id } })}>Cancel</Button>
